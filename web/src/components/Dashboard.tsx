...
const Dashboard: React.FC = () => {
  ...
  const statusColor = data.diagnosis === "DISTRACTED" ? "bg-red-600" : "bg-emerald-600";
    ...
    <div className="min-h-screen bg-slate-900 text-white p-6 font-mono">
      ...
      <div className={`${statusColor} rounded-lg p-6 mb-8 text-center shadow-lg border border-white/10`}>
        ...
        <div className="mt-4 flex justify-center gap-8 text-sm opacity-90">
          ...
          {activeTest === "DYSCALCULIA" && <>
            ...
            <div className="bg-black/20 px-4 py-2 rounded text-slate-400">STRESS: DISABLED</div>
          </>}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
          ...
          <div className="mt-4 text-xs text-center text-slate-400">Displaying: Theta (ADHD), Beta (Focus), Gamma (Cognitive Load)</div>
        </div>
      </div>
    </div>
  );
