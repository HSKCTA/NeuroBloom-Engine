        ...
        while True:
            ...
            if socket.poll(timeout=10): 
                ...
                if json_str:
                    ...
                    # B. DYSCALCULIA: Cognitive Load & Stress
                    cog_load = gamma / theta if theta > 0 else 0
                    stress_idx = h_beta / alpha if alpha > 0 else 0
                    ...
                    diagnosis = "FOCUSED"
                    # If TBR is high (ADHD) or Stress is high (Dyscalculia)
                    if tbr > 2.5 or yaw > 50: diagnosis = "DISTRACTED"
                    if stress_idx > 2.0: diagnosis = "HIGH STRESS"
